...
Clase que implementa la interface UsuarioService
...
public class UsuarioServiceImp implements UsuarioService 
{
	...
	@Transactional
	@Override
	public void agregar(String nombreUsuario, String contrasenia, String nombre, String apellido, String email,
			Perfil perfil)
	{
		Usuario usuario = new Usuario(nombreUsuario, passwordEncoder.encode(contrasenia), nombre, apellido, email,
				perfil);
	...
	@Transactional
	@Override
	public void modificarSinContrasenia(int id, String nombreUsuario, String nombre, String apellido, String email,
			Perfil perfil) 
	{
